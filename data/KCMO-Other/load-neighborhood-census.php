...
class KCMOTIF extends \Code4KC\Address\AreaLoad
{
    ...
    var $sql = "SELECT ogc_fid AS fid, wkb_geometry::geography::geometry AS geom, CONCAT(nbhname, ' (', nbhid , ')') AS name, lastupdate, shape_length, shape_area  FROM public.neighborhoodcensus;";
