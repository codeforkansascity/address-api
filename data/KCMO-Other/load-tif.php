...
class KCMOTIF extends \Code4KC\Address\AreaLoad
{
    ...
    var $sql = "SELECT fid, geom::geography::geometry AS geom, name, ordnum, status, amendment, lastupdate, shape_length, shape_area  FROM public.incentivetaxincrementfinancing;";
