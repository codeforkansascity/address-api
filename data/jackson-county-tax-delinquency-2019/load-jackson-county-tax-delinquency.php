...
class JacksonCountyTaxDeliquency extends \Code4KC\Address\BaseLoad
{
    ...
    function get_delinquencies()
    {
        ...
        $sql = "
            ...
            WHERE TRIM(physical_city) = 'KANSAS CITY'
    ...
    function process_current_parcel($current_county_address_id, $amts, $current_tax_rec)
    {
        ...
        if ($address_keys) {
            ...
            // TOTAL BAD APN by physical_address

            $physical_address = $current_tax_rec['physical_address'];
            array_key_exists($physical_address, $this->address_error_counts) ? $this->address_error_counts[$physical_address]++ : $this->address_error_counts[$physical_address] = 1;
